...
.. warning::
    ...
    use them to identify items. OpenZeppelin have a `ECDSA helper library <https://docs.openzeppelin.org/docs/cryptography_ecdsa>`_ that you can use as a replacement for ``ecrecover`` without this issue.
